...
public class SpringBeanHandlerInstantiator extends HandlerInstantiator {
	 ...
	 * deserializerInstance(DeserializationConfig config, Annotated annotated,
	 * Class<? extends JsonDeserializer<?>> deserClass) { try { return
	 * (JsonDeserializer<?>) applicationContext.getBean(deserClass); } catch
	 * (Exception e) { // Return null and let the default behavior happen }
	 * return null; }
	 * 
	 * @Override public KeyDeserializer
	 * keyDeserializerInstance(DeserializationConfig config, Annotated
	 * annotated, Class<? extends KeyDeserializer> keyDeserClass) { try { return
	 * (KeyDeserializer) applicationContext.getBean(keyDeserClass); } catch
	 * (Exception e) { // Return null and let the default behavior happen }
	 * return null; }
	 */
